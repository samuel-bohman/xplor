...
ui_names_bg <-
  c("area", "sex", "age", "occupation", "education", "years")
...
themes <-
  c(
    "1. Parker & grönområden",
    "2. Mångfald i bostadsutbudet",
...
alt_theme_1 <-
  c(
    "1a. Bevara existerande större grönområden",
...
alt_theme_4 <-
  c(
    "4a. Koppla ihop nya gator med befintliga för att stärka kopplingen till intilliggande stadsdelar och minska barriärerna som de stora vägarna utgör",
...
alt_theme_5 <-
  c(
    "5a. Utöka utbudet av kultur- sport- och fritidsaktiviteter",
...
alt_theme_7 <-
  c(
    "7a. Fler kultur- och fritidsaktiviteter för äldre",
...
alt_theme_8 <-
  c(
    "8a. Mindre barngrupper i förskolan",
...
alt_theme_9 <-
  c(
    "9a. Öka tryggheten kring stationsområdet",
...
alt_theme_10 <-
  c(
    "10a. Minska förbrukningen av energi",
